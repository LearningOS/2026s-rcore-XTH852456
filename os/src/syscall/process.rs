...
pub fn sys_get_time(ts: *mut TimeVal, _tz: usize) -> isize {
    ...
    let src = unsafe { core::slice::from_raw_parts((&tv as *const TimeVal) as *const u8, size_of::<TimeVal>()) };
    let mut dst = translated_byte_buffer(token, ts as *const u8, src.len());
